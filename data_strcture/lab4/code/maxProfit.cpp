...
int dp(){
    ...
    for (int i = n - 1;i >= 0; i--) {
        ...
        if(i == 0){
            ...
            if(f[i][current] != f[i - 1][current]){
                flag = 1;
                jobList.push_back(jobs[i].id);
            }
    }
    reverse(jobList.begin(), jobList.end());

    return f[n - 1][max_ddl];
}
...
void testBench(){
    ...
    cout << "Maximum profit for test bench: " << dp() << endl;
}
...
int main() {
    ...
    sort(jobs.begin(), jobs.end(), compareByDeadline);
    cout << "Maximum profit for case 1: " << dp() << endl;
    cout << "Job order: ( ";
    ...
    sort(jobs.begin(), jobs.end(), compareByDeadline);
    cout << "Maximum profit for case 2: " << dp() << endl;
    cout << "Job order: ( ";
    for (int i = 0; i < jobList.size(); ++i) 
        cout << jobList[i] << " ";
    cout << ")" << endl;
    ...
    sort(jobs.begin(), jobs.end(), compareByDeadline);
    cout << "Maximum profit for case 3: " << dp() << endl;
    cout << "Job order: ( ";
    for (int i = 0; i < jobList.size(); ++i) 
        cout << jobList[i] << " ";
    cout << ")" << endl;
    ...
    sort(jobs.begin(), jobs.end(), compareByDeadline);
    cout << "Maximum profit for case 4: " << dp() << endl;
    cout << "Job order: ( ";
    for (int i = 0; i < jobList.size(); ++i) 
        cout << jobList[i] << " ";
    cout << ")" << endl;
    ...
    sort(jobs.begin(), jobs.end(), compareByDeadline);
    cout << "Maximum profit for case 5: " << dp() << endl;
    cout << "Job order: ( ";
    for (int i = 0; i < jobList.size(); ++i) 
        cout << jobList[i] << " ";
    cout << ")" << endl;

    //To test the performance of dp algorithm
    auto start = high_resolution_clock::now();
    testBench();
    auto end = high_resolution_clock::now();
    duration<double> elapsed = end - start;
 
    cout << "Elapsed time for dp: " << elapsed.count() << " seconds" << endl;
